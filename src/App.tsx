  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
          ...
          {state.status === 'ok' && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              <div style={{
                ...
                boxShadow: isLive ? '0 0 0 2px rgba(16,185,129,0.2)' : '0 0 0 2px rgba(245,158,11,0.2)',
              }} />
              <span style={{ fontSize: 12, color: 'var(--text-muted)', fontWeight: 500 }}>
                {isLive ? 'Live — Remote API' : 'Snapshot (fallback)'}
              </span>
              <span style={{ color: 'var(--primary-mid)', fontSize: 12 }}>·</span>
      ...
      <div style={{ padding: '28px 32px' }}>
        ...
        {state.status === 'error' && (
          <div style={{ padding: 24, color: 'var(--danger)', background: 'var(--primary-light)', borderRadius: 12, border: '1px solid var(--primary-mid)', fontSize: 13 }}>
